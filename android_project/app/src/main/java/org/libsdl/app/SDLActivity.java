...
*/
    ...
    public static native void onNativeOrientationChanged(int newOrientation);
    ...
    public static native void nativeSetScreenResolution(int surfaceWidth, int surfaceHeight, int deviceWidth, int deviceHeight, float density);
